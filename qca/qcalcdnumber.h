 ...
 ***************************************************************************/
#ifndef QCALCDNUMBER_H
#define QCALCDNUMBER_H
...
*/
class QCALCDNumber : public QLCDNumber
{
	Q_OBJECT
...
public:
	...
	//QCALCDNumber(const QString &pvName, QWidget *parent = 0);
	QCALCDNumber ( QWidget *parent = 0 );
	~QCALCDNumber();
