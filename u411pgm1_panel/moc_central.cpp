...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Central_t, stringdata) + ofs \
...
void Central::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Central *_t = static_cast<Central *>(_o);
        switch (_id) {
        case 0: _t->textrecieved((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject Central::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Central.data,
      qt_meta_data_Central,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Central.stringdata))
        return static_cast<void*>(const_cast< Central*>(this));
